        ...
        <div style={{ marginTop: "4rem" }} className="row">
          <div className="col s8 offset-s2 cyan darken-4 white-text z-depth-5">
            ...
            <form noValidate onSubmit={this.onSubmit}>
              <div className="input-field col s10" style={{ marginTop: "2rem" }}>
                <input 
              ...
              <div className="input-field col s10" style={{ marginTop: "1rem" }}>
                <input
                  style={{ marginTop: "2rem", paddingLeft: "1rem" }}
                  onChange={this.onChange}
                ...
                />
                <label htmlFor="password" style={{ fontSize: "2rem" }}>Password</label>
                <span className="red-text">
                  {errors.password}
