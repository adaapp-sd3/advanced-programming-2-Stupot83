          ...
          <div className="col s12 center-align cyan darken-4 white-text z-depth-5 Landing">
            ...
            <div className="row Landing-synopsis" style={{ margin: "2rem" }}>
              <h4 style={{ marginBottom: "2rem" }}>
                Take on the role of a farmer in the game <b>Farm Manager!</b>{" "}
                ... Grow crops, raise livestock and buy and sell goods at the
                farmers market in an ever-changing economy and climate that is
                sure to test your decision making skills to the core ...{" "}
              </h4>
            </div>
            <a
              href="/register"
